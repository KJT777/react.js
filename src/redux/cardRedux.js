...
// selectors
// zadaniem jest dodanie drugiego warunku (połączonego operatorem oraz &&), który będzie sprawdzał czy tytuł karty pasuje do wyszukiwanej frazy, czyli: new RegExp(searchString, 'i').test(card.title) 
